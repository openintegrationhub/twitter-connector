...
const { transformUserToOih } = require('../actions/transformUserToOih');
  ...
  try {
    ...
    */
    const oihMeta = {
      ...
      schema: (cfg.schema !== undefined && cfg.schema !== null) ? cfg.schema : undefined,
      domainId: (cfg.domainId !== undefined && cfg.domainId !== null) ? cfg.domainId : undefined,
    };
